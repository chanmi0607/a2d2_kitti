...
from propose_main import filter_points_by_z_spread # propose_main.py에서 함수 임포트
...
def associate_clusters_with_gt(clusters, gt_boxes, distance_threshold=0):
    ...
    # 1. 모든 클러스터를 순회하며 어떤 GT 박스에 속하는지 매핑합니다.
